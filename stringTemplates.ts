...
export const helpText = cliHelpTemplate({
  ...
  new     Create a new entry point file
...
// Templates for pd new command
export const pdNewScriptTemplate = (name: string) =>
  `# ${name}
...
\`\`\`json
{
  "inputs": [{ "_name": "default" }]
}
\`\`\`
`;

export const pdNewServerMdTemplate = (name: string) =>
  `# ${name}
...
\`\`\`ts
input.body = { message: "Hello from ${name}!" };
\`\`\`
...
\`\`\`json
{
  "inputs": [{ "_name": "default", "request": {} }]
}
\`\`\`
`;

export const pdNewCliMdTemplate = (name: string) =>
  `# ${name}
...
export const pdNewCleanTemplate = (name: string) =>
  `# ${name}
...
export const pdNewWrapperTemplate = () =>
  `import pipe from "./index.ts";
